...
from .frontier_overlay import pack_rgb_image
from .object_model_process import ObjectModelProcess
from .openai_compatible import OpenAICompatibleTargetObserver
...
class ObjectLocalizer:
    def __init__(self, analyzer: OpenAICompatibleTargetObserver, config: ObjectLocalizerConfig, directory: Path, on_event=None):
    ...
    def locate(self, frame, goal, *, context) -> ObjectLocalization:
        ...
        _save_input(folder, image, frame, context)
...
def _save_input(folder, image, frame, context):
